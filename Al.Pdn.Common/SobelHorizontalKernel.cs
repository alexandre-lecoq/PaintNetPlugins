namespace Al.Pdn.Common
{
    ...
    /// <summary>
    /// Represents the Sobel horizontal convolution kernel.
    /// </summary>
    public class SobelHorizontalKernel : ConvolutionKernel<double>
    {
        private double[][] _kernelMatrix;
        private Rectangle _definitionRange;

        /// <summary>
        /// Initializes a new instance of the <see cref="SobelHorizontalKernel"/> class.
        /// </summary>
