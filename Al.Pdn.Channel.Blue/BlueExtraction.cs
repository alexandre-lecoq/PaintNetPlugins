namespace Al.Pdn.Channel.Blue
{
    ...
    /// <summary>
    /// Represents an effect extracting the blue channel of the picture.
    /// </summary>
    public class BlueExtraction : PropertyBasedEffect
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueExtraction"/> class.
        /// </summary>
        public BlueExtraction()
            ...
            for (int x = rect.Left; x < rect.Right; x++)
            {
                for (int y = rect.Top; y < rect.Bottom; y++)
                {
                    if (src.IsVisible(x, y))
                    {
                        ...
                        dst[x, y] = ColorBgra.FromBgra(sourceColor.B, sourceColor.B, sourceColor.B, sourceColor.A);
                    }
                }
            }
        }
