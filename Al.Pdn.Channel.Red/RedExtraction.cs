namespace Al.Pdn.Channel.Red
{
    ...
    /// <summary>
    /// Represents an effect extracting the red channel of the picture.
    /// </summary>
    public class RedExtraction : PropertyBasedEffect
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedExtraction"/> class.
        /// </summary>
        public RedExtraction()
            ...
            for (int x = rect.Left; x < rect.Right; x++)
            {
                for (int y = rect.Top; y < rect.Bottom; y++)
                {
                    if (src.IsVisible(x, y))
                    {
                        ...
                        dst[x, y] = ColorBgra.FromBgra(sourceColor.R, sourceColor.R, sourceColor.R, sourceColor.A);
                    }
                }
            }
        }
